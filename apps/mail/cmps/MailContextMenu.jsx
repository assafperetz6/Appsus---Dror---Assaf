export function MailContextMenu({ cursorPos, selectedMail, onRemoveMail, onLabelAs, onMarkAsRead, onMoveTo }) {

    return (
        <ul className="context-menu clean-list" style={cursorPos}>
